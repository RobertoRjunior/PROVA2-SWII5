		...
		<form action="insertOrders" method="post">
			<table>
				...
				<tr>
					...
					<td><input type="number" name="purch_amt" size="45" /></td>
				</tr>
				<tr>
					<th>Data:</th>
					<td><input type="date" name="ord_date" size="45" /></td>
				</tr>
				<tr>
					<th>Cliente Id:</th>
					<td><input type="number" name="customer_id" size="5" /></td>
				</tr>
				<tr>
					<th>Vendedor Id:</th>
					<td><input type="number" name="salesman_id" size="5" /></td>
				</tr>
				<tr>
